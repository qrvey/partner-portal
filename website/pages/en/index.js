  ...
  render() {
    ...
    const Categories = () => {
      const categories = [
        ...
        {name:'UI Documentation',path: siteConfig.baseUrl+'docs/ui-docs/basics/logging-in'},
        ...
        {name:'Releases Notes', path: siteConfig.baseUrl+'docs/release-notes/release-sep-2019'},
      ];
