...
| **value** | `Array` | Yes | List of values used to filter the data. Qrvey will return all the records that match the criteria defined in the filter. Depending on the column’s data type, you may require additional parameters. <br><br>Strings <br> <code style="color:#880000;display: block;"> "value": [ <br> <span style="padding: 25px">"United States"</span> <br>] </code> <br>Number or Date* <br> **lt**: Less than.* <br> **lte**: Less than or equal to.* <br> **gt**: Greater than.* <br> **gte**: Greater than or equal to.<br> <br>                                             <code style="color:#880000;">"value": [ <br> <span style="padding: 25px">{</span> <br><span style="padding: 35px">"gt": "10507.231" </span><br><span style="padding: 25px">}</span><br>] </code> <br> <br> <code style="color:#880000;"> "value": [<br><span style="padding: 25px"> {</span> <br> <span style="padding: 35px">"lte": "11/30/2016",</span><br><span style="padding: 35px"> "gte": "05/15/2014"</span> <br> <span style="padding: 25px">}<span><br>]</code> 
