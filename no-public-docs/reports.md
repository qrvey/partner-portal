...
## Data & Configuration
In order to begin creating charts and filters for your reports, you will need to have configured at least one dataset first. This can be done in the **[Data section](../datasets/data_overview.md)**. 
