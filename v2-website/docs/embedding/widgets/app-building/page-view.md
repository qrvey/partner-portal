...
```jsx
<qrvey-end-user settings="config" />
...
<iframe
  ...
  name="cp_embed_1"
  scrolling="no"
  src="https://codepen.io/qrveysamples/embed/MWbNapv?height=838&theme-id=34531&default-tab=result&user=qrveysamples&slug-hash=MWbNapv&pen-title=DOC%20-%20Page%20View%20(Jan2021)&name=cp_embed_1"
  style={{ width: "100%", overflow: "hidden", display: "block" }}
  title="DOC - Page View (Jan2021)"
  loading="lazy"
  id="cp_embed_MWbNapv"
/>
