...
-   API Key (for calling the API - if you need to obtain an API key, contact [help@qrvey.com](mailto:help@qrvey.com))
...
&gt; **Note**: User and Application API endpoints are under the Core group.
...
&gt; **Note 2**: Webforms, in general, are referred to as “_qrvey_”s.
