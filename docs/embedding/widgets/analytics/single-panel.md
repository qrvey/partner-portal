...
```jsx title="/src/components/ansimplescript.js
<an-panel config="anpanelConfig"></an-panel>
```

```jsx title="/src/components/ansimplescript2.js
<script>
var anpanelConfig = {
    "api_key": "<API_KEY>",
    "app_id": "<APP_ID>",
...
```jsx title="/src/components/ansimplescript3.js
...
<p class="codepen" data-height="838" data-theme-id="light" data-default-tab="result" data-user="qrveysamples" data-slug-hash="c395bd9162f9d675bb8d02317cc5a1e2"  data-pen-title="Sample- Qrvey Single Panel">
...
```jsx title="/src/components/ansimplescript4.js
<an-panel config="anpanelConfig"></an-panel>
```

```jsx title="/src/components/ansimplescript5.js
<button onClick="applyNewFilter()">Apply other filter</button>
```

``` jsx title="/src/components/ansimplescript6.js
<script>
var anpanelConfig = {
    "api_key": "<API_KEY>",
    "app_id": "<APP_ID>",
...
```jsx title="/src/components/ansimplescript7.js
<script>
...
```jsx title="/src/components/ansimplescript8.js
<!-- your launcher js link (replace with your js link) -->
<script type="module" src="https://<WIDGETS_URL>/your_qrvey_an_widgets_container/an-dashboard/andashboard/andashboard.esm.js"></script>
<script nomodule src="https://<WIDGETS_URL>/your_qrvey_an_widgets_container/an-dashboard/andashboard/andashboard.js"></script>
```
...
#### See the widget in CodePen:
<p class="codepen" data-height="838" data-theme-id="light" data-default-tab="result" data-user="qrveysamples" data-slug-hash="e3f93036442bf01d677a53431438b6a5"  data-pen-title="Single Panel (AN Panel) Sample - Filters generated by user">
