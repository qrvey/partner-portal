...
The End User widget allows a user to one or more pages of an application created from Page Builder Widget. Pages may contain embedded reports and forms, as well as other static content.

## Widget Overview

The End User widget allows a user to one or more pages of an application created from Page Builder Widget.
