...
<li> a) If the Chart Builder is accessed from the Analyze section, the dataset is the one that you are analyzing and this step is automatically skipped. </li></br>
<li>b) If accessed from the Page or Report Builder, the list of the available datasets appears in the data panel and you have to select one of them. In this case you can also search for the dataset by entering any part of its name in the search box. 
...
Selecting the dataset will list its columns in the Data Panel. You can click on the left arrow next to the caption of the Data Panel to go back to the list of datasets and choose a different one to use for the chart. You will lose your created chart if you choose a different dataset.
...
under and depend on the said dataset. </li></ul>
