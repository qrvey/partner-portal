...
title: Filters in Widgets
sidebar_label: Filters in Widgets
...
| **questionType** | `String`| Yes | It’s only required if the column used to refine the data is a `FORMULA` or a `BUCKET`; otherwise, it is optional. Allowed values: <br />* FORMULA <br />* BUCKET |
