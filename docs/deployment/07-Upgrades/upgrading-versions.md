...
1. Get the URL for the latest version of the CloudFormation template (see <a href="/docs/release-notes/release-and-upgrade-notes" target="_blank">release notes</a>).
