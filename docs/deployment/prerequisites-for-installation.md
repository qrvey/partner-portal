...
* To avoid an interruption of service, contact AWS to disable Lambda recursive loop detection. For more information, see [Disabling Lambda Recursive Loop Detection](../deployment/06-Management/disabling-lambda-recursive-loop-detection.md).
