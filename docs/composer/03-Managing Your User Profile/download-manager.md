...
Download Manager is an embeddable widget. Click the **Embedding Options** button to obtain the helper code. For more information on embedding widgets, see [Embedding Overview]().
