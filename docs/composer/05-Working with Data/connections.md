...
- File upload time to S3 is automatically used as a timestamp to enable the [append and update](./Datasets/02-Design/data-synchronization.md#data-source-settings) mode for data synchronization. 
