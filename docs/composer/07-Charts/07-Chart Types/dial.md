...
* **(Fixed) Value**. Set the value for the criteria. To set a custom token, enter `{{` and begin typing the name of the token until it displays in the suggestion box. For more information, see [Using Custom Tokens](../../../software-developer/04-Widgets/custom-tokens.md).
...
For more on the Dial Gauge and other KPI Charts, we recommend watching <a href="/docs-v2/guides/legacy/kpi.md" target="_blank">this video</a>.
