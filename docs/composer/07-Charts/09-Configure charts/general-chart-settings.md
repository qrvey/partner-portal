...
Toggle the **Tooltips** option to display additional information when hovering over data points in a chart. You can also custom-configure information displayed in a widget's chart tooltips using a [Custom Token](../../../software-developer/04-Widgets/custom-tokens.md).
